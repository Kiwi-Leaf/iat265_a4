	...
	protected void stateScript(int worldState) {
		...
		if (worldState == MORNING) {
			if (currentConversation == 1) {
				...
				activeImage = iris.get(0);
				speaker = "Iris";
				speechContent = "Alright, let's see... what do I need to do.";
				...
				activeImage = null;
				speaker = "";
				speechContent = "Use 'A' or 'D' to move around. Click on item when you are close to get it. Press Space to drop item.";
				autoNextConversation();
			...
			if (currentConversation == 1) {
				...
				speaker = "Felicia";
				speechContent = "Uh... Hello...Um... May I please get some flowers for my friends, it would be best if it is blue...";
				if (midStop) {
					currentConversation++;
					conversationTimer = 120;
					midStop = false;
				...
				speaker = "Iris";
				speechContent = "... I hope the flowers can help her friend...";
				autoNextConversation();
			}
		} else if (worldState == EVENING) {
			if (currentConversation == 1) {
				...
				activeImage = iris.get(0);
				speaker = "Iris";
				speechContent = "Ok, Rose..rose...Where are they?";
				if (midStop) {
					currentConversation++;
					conversationTimer = 120;
					midStop = false;
				...
				activeImage = iris.get(0);
				speaker = "Iris";
				speechContent = "Phew... Alright, let's close the store and end the day.";
				if (midStop) {
					currentConversation++;
					conversationTimer = 120;
					midStop = false;
				}
			} else if (currentConversation == 10) {
				imageOnRight = true;
				activeColor = irisColor;
				activeImage = iris.get(2);
				speaker = "Iris";
